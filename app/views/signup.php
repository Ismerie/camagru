<div>
  ...
  <div id="signupForm" class="min-h-screen flex flex-col items-center sm:justify-center">
    <div class="relative z-10 px-10 sm:py-14 sm:bg-[--color-lightwhite] sm:rounded-lg sm:border-2 sm:border-[#f4f4f2]">
      ...
      <form class="space-y-2 mt-12 w-96 mb-12">
        ...
        <div class="floating-label">
          <input type="text" name="email" placeholder=" " required class="peer rounded-3xl p-3" />
          <label>Email</label>
        </div>
